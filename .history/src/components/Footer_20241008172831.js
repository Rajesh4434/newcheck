        ...
        <div>
            <footer className="bg-[#151518] mt-10">
                    ...
                    <div className="lg:flex lg:justify-between">
                        <div class="mb-6 lg:mb-0">
                            <Link class="flex items-center w-fit" href="/">
                                <p class="Airin self-center !text-4xl tracking-wider font-medium whitespace-nowrap dark:text-white">Iggy</p>
                                </Link>
                        ...
                        <div className="grid grid-cols-2 lg:gap-16 sm:gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                <ul className="font-semibold flex flex-col gap-2 lg:text-[0.85rem] text-[0.7rem] text-[#ffffffb2]">
                                    ...
                                    <li>
                                        <Link href="#" target='_blank' className="hover:text-white !font-semibold !text-[0.8rem]">Donate</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="mx-auto w-full lg:max-w-[83%] lg:flex lg:items-center lg:justify-between lg:text-[0.8rem] text-[0.7rem] text-[#ffffffb2] py-3">
                    <span className="sm:text-center ms-5 lg:ms-0">© {year} <Link href="/" className="hover:text-white">Goanime.me™</Link> | Made by <span className="font-bold" >Iggy</span>
                    </span>

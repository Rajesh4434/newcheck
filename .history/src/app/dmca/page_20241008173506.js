    ...
    <div>
      ...
      <div className="mx-auto w-[94%] lg:w-[80%]">
        ...
        <p className="mt-4 text-[#bdbdbd]">
          iggy is committed to respecting the intellectual property
        ...
        <p className="mt-4 text-[#bdbdbd]">
          None of the files listed on iggy are hosted on our servers. All
          ...
          to{" "}
          <Link href="mailto:contact@iggy" className="text-white">
            contact@iggy
          </Link>{" "}
